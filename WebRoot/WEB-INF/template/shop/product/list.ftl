...
[#if productCategory??]
	[@seo type = "productList"]
		<title>[#if productCategory.seoTitle??]${productCategory.seoTitle}[#elseif seo.title??][@seo.title?interpret /][/#if][#if systemShowPowered] - Powered By KORRES[/#if]</title>
	...
	[/@seo]
[#else]
	<title>${message("shop.product.title")}[#if systemShowPowered] - Powered By KORRES[/#if]</title>
	<meta name="author" content="YANHAO Team" />
	<meta name="copyright" content="YANHAO" />
[/#if]
