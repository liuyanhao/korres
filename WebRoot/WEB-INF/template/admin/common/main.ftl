...
<title>${message("admin.main.title")} - Powered By TOOXIU</title>
...
<body>
	...
	<table class="main">
		<tr>
			<th class="logo">
				<a href="main.jhtml">
					<img src="${base}/resources/admin/images/header_logo.gif" alt="KORRES" />
				</a>
			</th>
			<th>
				...
				<div class="link">
					<a href="http://www.yanhaoit.top" target="_blank">${message("admin.main.official")}</a>|
					<a href="http://bbs.yanhaoit.top" target="_blank">${message("admin.main.bbs")}</a>|
					<a href="http://www.yanhaoit.top/about.html" target="_blank">${message("admin.main.about")}</a>
				</div>
				<div class="link">
