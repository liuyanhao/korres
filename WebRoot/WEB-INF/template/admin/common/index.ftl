...
<title>${message("admin.index.title")} - Powered By TOOXIU</title>
...
<body>
	...
	<table class="input">
		...
		<tr>
			...
			<td>
				<a href="http://www.yanhaoit.top" target="_blank">http://www.yanhaoit.top</a>
			</td>
			<th>
				${message("admin.index.bbs")}:
			</th>
			<td>
				<a href="http://bbs.yanhaoit.top" target="_blank">http://bbs.yanhaoit.top</a>
			</td>
		</tr>
		<tr>
			<td colspan="4">
		...
		<tr>
			<td class="powered" colspan="4">
				COPYRIGHT © 2018-2020 YANHAOIT.CO ALL RIGHTS RESERVED.
			</td>
		</tr>
	</table>
</body>
