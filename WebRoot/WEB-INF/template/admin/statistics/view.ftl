...
<title>${message("admin.statistics.view")} - Powered By TOOXIU</title>
...
<body>
	...
	[#if setting.cnzzSiteId?has_content && setting.cnzzPassword?has_content]
		<iframe frameborder="0" width="100%" height="100%" src="http://intf.cnzz.com/user/companion/korres_login.php?site_id=${setting.cnzzSiteId}&password=${setting.cnzzPassword}"></iframe>
	[/#if]
</body>
</html>