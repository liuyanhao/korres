...
<title>${message("admin.plugin.alipayDirect.setting")} - Powered By TOOXIU</title>
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		<table class="input">
			...
			<tr>
				<th>
					<span class="requiredField">*</span>${message("admin.plugin.alipayDirect.sellerEmail")}:
				</th>
				<td>
					<input type="text" name="sellerEmail" class="text" value="${pluginConfig.attributes['sellerEmail']}" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
